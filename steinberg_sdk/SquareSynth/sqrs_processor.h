...
//------------------------------------------------------------------------
class SquareSynthProcessor : public Steinberg::Vst::AudioEffect
{
public:
	SquareSynthProcessor ();
	~SquareSynthProcessor () SMTG_OVERRIDE;

    // Create function
	static Steinberg::FUnknown* createInstance (void* /*context*/) 
	{ 
		return (Steinberg::Vst::IAudioProcessor*)new SquareSynthProcessor; 
	}
