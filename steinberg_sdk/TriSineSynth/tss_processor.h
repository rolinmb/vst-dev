...
//------------------------------------------------------------------------
class TriSineSynthProcessor : public Steinberg::Vst::AudioEffect
{
public:
	TriSineSynthProcessor ();
	~TriSineSynthProcessor () SMTG_OVERRIDE;

    // Create function
	static Steinberg::FUnknown* createInstance (void* /*context*/) 
	{ 
		return (Steinberg::Vst::IAudioProcessor*)new TriSineSynthProcessor; 
	}
